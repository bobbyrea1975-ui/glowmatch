    ...
    <main className="min-h-screen bg-paper">
      ...
      <section className="mx-auto max-w-3xl px-6 pt-20 pb-16 text-center">
        ...
        <p className="mx-auto mt-6 max-w-xl text-lg text-ink/80">
          ...
          then tracks what's working, so you stop guessing and start seeing
          results.
        </p>

        {/* Signature layering bar — represents the 3 routine steps,
            reused later as the quiz progress indicator */}
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        <div className="grid gap-8 sm:grid-cols-3">
          <Step
            color="bg-sage"
            title="Cleanse the guesswork"
            body="Answer a few quick questions about your skin. No account needed."
          />
          <Step
            color="bg-coral"
            title="Treat with a real match"
            body="Get product picks based on your skin type and concerns, not what's trending."
          />
          <Step
            color="bg-gold"
            title="Moisturize your routine"
            body="Go deeper with the full profile: environment, goals, and a plan that adjusts as your skin changes."
          />
        </div>
      </section>
