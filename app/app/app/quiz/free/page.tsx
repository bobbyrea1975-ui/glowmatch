...
// Placeholder recommendation logic — Phase 2 replaces this with the real
// product database, matched by tags. This keeps the free quiz functional
// end-to-end while that database is built.
